...
oracle_cache_path = "cache/oracle/wiki_talk_first_timestamp.jsonl"
oracle_cache_task_name = "wiki_talk_first_timestamp"
...
df["output_oracle"] = df["first_timestamp"]
...
for _, row in df.iterrows():
    score = judge(task, str(row["document"]), str(row["output_oracle"]), str(row["first_timestamp"]))
    scores.append(score)
...
save_outputs_df(df, "results/wiki_talk_first_timestamp_outputs.csv")
...
append_results_row(
    script_name="wiki_talk_first_timestamp",
