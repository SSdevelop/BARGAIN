...
oracle_cache_path = "cache/oracle/court_reverse.jsonl"
oracle_cache_task_name = "court_reverse"
...
output, used_oracle = bargain.process(
    df["opinion_text"].astype(str).tolist(), return_oracle_usage=True
)
...
save_outputs_df(df, "results/court_reverse_base_outputs.csv")
...
append_results_row(
    script_name="court_reverse_base",
