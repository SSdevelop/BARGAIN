...
oracle_cache_path = "cache/oracle/wiki_talk_extract_usernames.jsonl"
oracle_cache_task_name = "wiki_talk_extract_usernames"
...
df["output_oracle"] = df["extracted_usernames"]
...
for _, row in df.iterrows():
    score = judge(task, str(row["document"]), str(row["output_oracle"]), str(row["extracted_usernames"]))
    scores.append(score)
...
save_outputs_df(df, "results/wiki_talk_extract_usernames_outputs.csv")
...
append_results_row(
    script_name="wiki_talk_extract_usernames",
