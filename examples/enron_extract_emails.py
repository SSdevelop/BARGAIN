...
oracle_cache_path = "cache/oracle/enron_extract_emails.jsonl"
oracle_cache_task_name = "enron_extract_emails"
...
df["output_oracle"] = df["extracted_emails"]
...
for _, row in df.iterrows():
    score = judge(task, str(row["text"]), str(row["output_oracle"]), str(row["extracted_emails"]))
    scores.append(score)
...
save_outputs_df(df, "results/enron_extract_emails_outputs.csv")
...
append_results_row(
    script_name="enron_extract_emails",
